...
const todos: By =  By.css('li.todo');//By.className('selected');
// this locator will find the text of a todo FROM the todo
const todoLabel: By = By.xpath('//label[text()="Test To-Do"]');
// this locator will find the checkbox for the todo FROM the todo
const todoComplete: By = By.xpath('(//input[@class="toggle"])[1]');
